...
> [!CAUTION]
> Gum v2 have a lot of bags, so my scripts don't work correctly with it
> To make all work download binnary v1.7 from [official GitHub page](https://github.com/charmbracelet/gum/releases/download/v0.17.0/gum_0.17.0_Linux_x86_64.tar.gz).<br>
...
```
Also it may be cloned from one of those mirrors:
