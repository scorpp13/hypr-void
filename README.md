...
> browser, terminal emulator, gui file manager, cli file manager, media player, volume control.
...
> [!IMPORTANT]
> <ins>After launching the Hypr-Void environment for the first time:</ins><br>
