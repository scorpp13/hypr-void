...
> - In this case, you can remove them from necessary-packages. I don't recommend doing this. Otherwise, the Hypr-Void environment will not function properly until you make the necessary changes to the configuration files of the environment components.<br>
